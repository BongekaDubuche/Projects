...
# As a player of the game, I should see some kind of text header, welcome or game intro message in the console.
...
def start_game():
    ...
    while int(guess) != number_to_guess:
        ...
        print("Your guessed the in ," + str(guess_count) + "tries!")
        print("Game Over!!")
